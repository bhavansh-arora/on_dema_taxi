            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Driver</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Customer</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">New ride</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Confirmed ride</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">On ride</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Completed ride</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Canceled ride</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Driver sale today</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Commission for the day</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Commission for the week</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Commission for the month</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row m-t-0">
                    <div class="col-md-12">
                        ...
                        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyANlF_WCJlWnmuO1Zp2zh8rIotcbspoTKQ&callback=initMap">
                        </script>
